...
load_dotenv()  # Carica le variabili d'ambiente dal file .env (opzionale)
app = Flask(__name__)


database_url = os.getenv('DATABASE_URL')  # Definizione corretta di database_url

# Configura il database
if database_url:
    # Se DATABASE_URL è definito (produzione), usa PostgreSQL
    app.config['SQLALCHEMY_DATABASE_URI'] = database_url
else:
    # Altrimenti, usa SQLite (sviluppo locale)
